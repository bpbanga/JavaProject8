...
public class TestTourGuideService {
	...
	public void getUserLocation() throws InterruptedException, ExecutionException {
		...
		//single instance of rewardCentral
		...
		//try catch allowing a wait of one second so that all  trackUserLocation operations    
		//can be carried out
		try {
	...
	public void getNearbyAttractions() throws InterruptedException, ExecutionException {
		...
		List<UserNerarbyAttraction> attractions = tourGuideService.getNearByAttractions(user.getLastVisitedLocation());
